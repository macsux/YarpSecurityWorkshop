...
namespace IdentityServerDemo
{
    public class ConfigUserStore
    {
        ...
        {
            return AllUsers.FirstOrDefault(x => x.SubjectId == subjectId);
        }
        /// <summary>
        ...
        {
            return AllUsers.FirstOrDefault(x => x.Username.Equals(username, StringComparison.OrdinalIgnoreCase));
        }
        ...
        {
            return AllUsers.FirstOrDefault(x =>
